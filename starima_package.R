...
plot(stacf, main="ST Autocorrelation",xlab="Time Lags", ylab="ST-Autocorrelation", type="h", col="red", ylim=c(min(stacf), max(stacf)));
...
partialSTACF[order,1]<-model$BETA[len];
...
plot(partialSTACF, main="ST Partial Autocorrelation",xlab="Time Lags", ylab="ST-Partial Autocorrelation", type="h", col="red", ylim=c(-0.25, 1));
